"""
Public Ads Dashboard API - Main Application

FastAPI application providing comprehensive APIs for the Public Ads
...
app = FastAPI(
    ...
    description="""
## Public Ads Dashboard API

Full-stack monitoring and control dashboard for the Public Ads Pipeline.
