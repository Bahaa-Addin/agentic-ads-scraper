# =============================================================================
# Creative Ads Dashboard - Terraform Configuration
# =============================================================================
...
resource "google_service_account" "dashboard" {
  account_id   = "creative-ads-dashboard"
  display_name = "Creative Ads Dashboard Service Account"
  description  = "Service account for the Creative Ads Dashboard"
  project      = var.project_id
}
...
resource "google_artifact_registry_repository" "dashboard" {
  location      = var.region
  repository_id = "creative-ads-dashboard"
  description   = "Docker images for Creative Ads Dashboard"
  format        = "DOCKER"
  labels        = local.labels
}
...
resource "google_monitoring_dashboard" "dashboard" {
  dashboard_json = jsonencode({
    displayName = "Creative Ads Dashboard"
    gridLayout = {
      columns = 2
      widgets = [
        {
