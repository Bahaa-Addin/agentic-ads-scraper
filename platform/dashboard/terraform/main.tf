# =============================================================================
# Public Ads Dashboard - Terraform Configuration
# =============================================================================
...
resource "google_service_account" "dashboard" {
  account_id   = "public-ads-dashboard"
  display_name = "Public Ads Dashboard Service Account"
  description  = "Service account for the Public Ads Dashboard"
  project      = var.project_id
}
...
resource "google_artifact_registry_repository" "dashboard" {
  location      = var.region
  repository_id = "public-ads-dashboard"
  description   = "Docker images for Public Ads Dashboard"
  format        = "DOCKER"
  labels        = local.labels
}
...
resource "google_monitoring_dashboard" "dashboard" {
  dashboard_json = jsonencode({
    displayName = "Public Ads Dashboard"
    gridLayout = {
      columns = 2
      widgets = [
        {
