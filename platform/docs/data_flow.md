...
This document describes the data flow through the Public Ads Platform pipeline.
...
Pub/Sub:
├── public-ads-jobs                 # Main job topic
├── public-ads-jobs-sub             # Subscription
└── public-ads-jobs-dlq             # Dead letter queue
```
