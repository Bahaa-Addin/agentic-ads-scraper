...
The Public Ads Platform is a **local-first, cloud-optional agentic system** for scraping, analyzing, and generating reverse prompts for creative advertisements. It features **real-time live streaming** of browser sessions for monitoring scraper activity.
