...
- Respect source-specific terms of service, rate limits, and applicable laws before scraping.
- Keep `.env` files, service-account JSON files, and private datasets local only.
- Sanitize logs and fixtures before committing anything generated by a real run.
...
# Pull a model
docker exec -it public-ads-platform_ollama_1 ollama pull llama2
```
