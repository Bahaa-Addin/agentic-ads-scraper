...
The Agent Brain is the central orchestrator for the public ads platform.
...
class PipelineStage(Enum):
    """Stages in the public ads processing pipeline."""
    SCRAPING = "scraping"
...
class AgentBrain:
    """
    Central orchestration engine for the public ads platform.
