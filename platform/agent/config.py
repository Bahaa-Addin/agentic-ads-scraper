"""
Configuration Management for Public Ads Platform
...
class Config:
    ...
    pubsub_topic: str = "public-ads-jobs"
    pubsub_subscription: str = "public-ads-jobs-sub"
    pubsub_dlq_topic: str = "public-ads-jobs-dlq"
    ...
    def from_environment(cls) -> "Config":
        ...
        config = cls(
            ...
            pubsub_topic=os.environ.get("PUBSUB_TOPIC", "public-ads-jobs"),
            pubsub_subscription=os.environ.get(
                "PUBSUB_SUBSCRIPTION", "public-ads-jobs-sub"
            ),
