# Public Ads Platform - Main Terraform Configuration
#
# This configuration provisions all GCP infrastructure required for the
# public ads scraping and reverse-prompting platform.
...
resource "google_service_account" "platform" {
  ...
  display_name = "Public Ads Platform Service Account"
  description  = "Service account for the public ads platform components"
  project      = var.project_id
}
...
resource "google_bigquery_dataset" "analytics" {
  ...
  friendly_name              = "Public Ads Analytics"
  description                = "Analytics dataset for public ads platform"
...
resource "google_monitoring_alert_policy" "high_error_rate" {
  ...
  documentation {
    content   = "High error rate detected in Public Ads Platform services."
