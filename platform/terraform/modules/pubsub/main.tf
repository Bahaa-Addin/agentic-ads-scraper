...
locals {
  topic_name     = "public-ads-jobs"
  dlq_topic_name = "public-ads-jobs-dlq"
}
...
resource "google_pubsub_topic" "feature_extraction" {
  name    = "public-ads-feature-extraction"
  project = var.project_id
...
resource "google_pubsub_subscription" "feature_extraction" {
  name    = "public-ads-feature-extraction-sub"
  project = var.project_id
...
resource "google_pubsub_topic" "prompt_generation" {
  name    = "public-ads-prompt-generation"
  project = var.project_id
...
resource "google_pubsub_subscription" "prompt_generation" {
  name    = "public-ads-prompt-generation-sub"
  project = var.project_id
