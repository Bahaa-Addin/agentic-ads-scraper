...
#
#   name        = "public-ads-metadata"
#   description = "Metadata store for public ads ML experiments"
#   region      = var.region
# }
...
resource "google_vertex_ai_tensorboard" "creative_ads" {
  ...
  display_name = "public-ads-tensorboard"
  description  = "Tensorboard for public ads model training"
  region       = var.region
...
resource "google_vertex_ai_dataset" "creative_ads" {
  ...
  display_name        = "public-ads-dataset"
