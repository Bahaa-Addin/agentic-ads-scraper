# 🎨 Creative Ads Dashboard

A comprehensive full-stack monitoring and control dashboard for the Agentic Creative Ads Pipeline. This dashboard provides real-time visibility and control over scraping jobs, feature extraction, reverse-prompt generation, and industry classification.
...
1. **Clone the repository**
   ```bash
   cd creative-ads-platform/dashboard
   ```
...
| `AGENT_SERVICE_URL` | URL of the Agent Brain service | `http://localhost:8080` |
| `SCRAPER_SERVICE_URL` | URL of the Scraper service | `http://localhost:3000` |
