    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-surface-400 mt-1">
          Configure your dashboard and pipeline settings
        </p>
      </div>
          ...
          {activeTab === 'storage' && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Firestore and Cloud Storage settings
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <Input
                    label="Firestore Collection Prefix"
                    defaultValue="creative_ads"
                    disabled
                  />
                  <Input
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <Input
                    label="Pub/Sub Topic"
                    defaultValue="creative-ads-jobs"
                    disabled
                  />
                  <div className="pt-4">
                    <a
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-surface-400">
                        Alert when queue exceeds 100 items
                      </p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
